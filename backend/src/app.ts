...
// trust proxy: true — X-Forwarded-For dagi BIRINCHI (haqiqiy) IP ni oladi.
// Render bir necha proxy qatlami ishlatadi (CDN + LB), shuning uchun
// trust proxy: 1 ichki 10.x.x.x IP ni qaytarardi — bu xato edi.
